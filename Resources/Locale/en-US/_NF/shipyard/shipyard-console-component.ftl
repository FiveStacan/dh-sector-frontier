...
shipyard-console-parking-invalid-dock = The selected docking port is invalid.
shipyard-console-parking-no-docking-path = Unable to recall the shuttle to the selected docking port.
shipyard-console-parking-cryo-pod-aboard = A player cryosleep pod is installed aboard this shuttle. It cannot be sent to parking.
shipyard-console-parking-status-parked = Status: parked
shipyard-console-parking-status-active = Status: active
shipyard-console-parking-price = Parking price: { $price }
shipyard-console-parking-time-remaining = Parking time remaining: { $time }
shipyard-console-parking-cooldown = Parking system busy: { $time }
shipyard-console-parking-extend = Extend +5 min
shipyard-console-parking-extend-unavailable = Parking time cannot be extended.
