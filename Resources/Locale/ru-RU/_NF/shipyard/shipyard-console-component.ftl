...
shipyard-console-parking-price = Стоимость парковки: { $price }
shipyard-console-parking-time-remaining = Осталось времени стоянки: { $time }
shipyard-console-parking-cooldown = Система парковки занята: { $time }
shipyard-console-parking-extend = Продлить +5 мин
shipyard-console-parking-extend-unavailable = Нельзя продлить время стоянки.
...
shipyard-console-class-Cargo = Грузовой
