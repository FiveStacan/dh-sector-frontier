...
public sealed partial class GeneralStationRecordConsoleWindow : DefaultWindow
{
    ...
    public GeneralStationRecordConsoleWindow()
    {
        ...
        AdSubmitButton.OnPressed += _ =>
        {
            ...
            {
                _lastAdvertisement = advertisementText;
    ...
    public void UpdateState(GeneralStationRecordConsoleState state)
    {
        ...
        {
            HiringContainer.Visible = true;
            PopulateJobsContainer(state.JobList);
        }
        else
        {
            HiringContainer.Visible = false;
    ...
    private void PopulateJobsContainer(IReadOnlyDictionary<ProtoId<JobPrototype>, int?> jobList)
    {
        ...
        foreach (var (job, amount) in jobList)
        {
            ...
            var jobName = _prototype.TryIndex(job, out var jobProto)
            ...
            jobEntry.DecreaseJobSlot.OnPressed += _ => OnJobSubtract?.Invoke(job);
            jobEntry.IncreaseJobSlot.OnPressed += _ => OnJobAdd?.Invoke(job);
    ...
    private string GetAdvertisementString()
    {
        ...
        if (advertisementText.Length > MaxAdvertisementLength)
            advertisementText = advertisementText[..MaxAdvertisementLength];
