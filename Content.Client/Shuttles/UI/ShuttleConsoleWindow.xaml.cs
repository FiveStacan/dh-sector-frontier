    ...
    IComputerWindow<ShuttleBoundUserInterfaceState>
{
    ...
    public event Action? OnInterserverRefresh;
    public event Action<string, string>? OnInterserverTransfer;
    ...
    public ShuttleConsoleWindow()
    {
        ...
        LongRangeBssModeButton.OnPressed += LongRangeBssPressed;
        ...
        LongRangeBssModeButton.Group = group;
        ...
        LongRangeBssContainer.RequestRefresh += () => OnInterserverRefresh?.Invoke();
        LongRangeBssContainer.RequestTransfer += (server, map) => OnInterserverTransfer?.Invoke(server, map);
        // Lua end: StarMap
    ...
    private void ClearModes(ShuttleConsoleMode mode)
    {
        ...
        if (mode != ShuttleConsoleMode.LongRangeBss)
        { LongRangeBssContainer.Visible = false; }
    ...
    private void LongRangeBssPressed(BaseButton.ButtonEventArgs obj)
    {
        SwitchMode(ShuttleConsoleMode.LongRangeBss);
    }
    ...
    private void SetupMode(ShuttleConsoleMode mode)
    {
        switch (mode)
        {
            ...
            case ShuttleConsoleMode.StarMap:
                ...
                break;
            case ShuttleConsoleMode.LongRangeBss:
                LongRangeBssContainer.Visible = true;
                OnInterserverRefresh?.Invoke();
                break;
    ...
    public void UpdateState(EntityUid owner, ShuttleBoundUserInterfaceState cState)
    {
        ...
        LongRangeBssContainer.UpdateState(cState.StarMapState.Interserver);
